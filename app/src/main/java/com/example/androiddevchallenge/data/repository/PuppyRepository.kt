...
import com.example.androiddevchallenge.data.dto.PuppyResponse
import com.example.androiddevchallenge.data.dto.toModel
...
class PuppyRepository {
  ...
  private val _puppies by lazy {
    json.decodeFromString<List<PuppyResponse>>(responseJson).map { it.toModel() }
  }
  ...
  fun getPuppy(id: Id.Puppy): Puppy? {
    return _puppies.firstOrNull { it.id == id }
  }
}
